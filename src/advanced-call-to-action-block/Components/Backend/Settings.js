...
function Settings({ attributes, setAttributes }) {
    ...
    return (
        <>
            <InspectorControls>
                <PanelBody title={__('General', 'hazrath-advanced-cta-block')} initialOpen={true}>
                    <SelectControl
                        label={__('Heading HTML Tag', 'hazrath-advanced-cta-block')}
                        value={headingTag}
                        options={[
                            { label: 'H1', value: 'h1' },
                            { label: 'H2', value: 'h2' },
                    ...
                    />
                    <TextControl
                        label={__('Heading Text', 'hazrath-advanced-cta-block')}
                        value={attributes.heading}
                        onChange={(value) => setAttributes({ heading: value })}
                    />
                    <TextControl
                        label={__('Description Text', 'hazrath-advanced-cta-block')} 
                        value={attributes.description}
                        onChange={(value) => setAttributes({ description: value })}
                    />
                    <SelectControl
                        label={__('Alignment', 'hazrath-advanced-cta-block')}
                        value={alignment}
                        options={[
                ...
                <PanelBody title={__('Button', 'hazrath-advanced-cta-block')} initialOpen={false}>
                    <TextControl
                        label={__('Button Text', 'hazrath-advanced-cta-block')}
                        value={buttonText}
                        onChange={(value) => setAttributes({ buttonText: value })}
                    />
                    <TextControl
                        label={__('Button URL', 'hazrath-advanced-cta-block')}
                        value={buttonUrl}
            ...
            <InspectorControls group="styles">
                <PanelBody title={__('Section Layout', 'hazrath-advanced-cta-block')} initialOpen={true}>
                ...
                <PanelBody title={__('Heading Styles', 'hazrath-advanced-cta-block')} initialOpen={false}>
                    <TypographyControl attributes={attributes} setAttributes={setAttributes} prefix="heading" />
                    <ColorControl
                        label={__('Color', 'hazrath-advanced-cta-block')}
                        value={headingColor}
                ...
                <PanelBody title={__('Description Styles', 'hazrath-advanced-cta-block')} initialOpen={false}>
                ...
                <PanelBody title={__('Button Styles', 'hazrath-advanced-cta-block')} initialOpen={false}>
                    <TypographyControl attributes={attributes} setAttributes={setAttributes} prefix="button" />
                    <ColorControl
                        label={__('Text Color', 'hazrath-advanced-cta-block')}
                    ...
                    />
                    <ColorControl
                        label={__('Background Color', 'hazrath-advanced-cta-block')}
