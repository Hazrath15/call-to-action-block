        ...
        <style>
            {`
				/* -------------------------------------------------
				   SECTION (container)
				   ------------------------------------------------- */
				.wp-block-create-block-advanced-call-to-action-block {
				...
				/* -------------------------------------------------
				   HEADING
				   ------------------------------------------------- */
				.wp-block-create-block-advanced-call-to-action-block .hero-content .main-heading {
				...
				/* -------------------------------------------------
				   DESCRIPTION
				   ------------------------------------------------- */
				.wp-block-create-block-advanced-call-to-action-block .hero-content .description {
				...
				/* -------------------------------------------------
				   BUTTON
				   ------------------------------------------------- */
				.wp-block-create-block-advanced-call-to-action-block .hero-content .cta-button {
